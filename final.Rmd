...
```{r turnout, echo=FALSE, message=FALSE, error=FALSE, cache=TRUE}
...
```{r simulation, echo=FALSE, cache=TRUE}
...
```{r table1, echo=FALSE, message=FALSE, error=FALSE, results='asis', fig.align='center'}
